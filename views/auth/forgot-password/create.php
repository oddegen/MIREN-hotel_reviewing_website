...
<div class="flex flex-col px-6 py-12 lg:px-8 justify-center">
  ...
  <?php if (isset($_SESSION['_flash']['email_confirmation'])) : ?>
    <div class="bg-green-400 text-green-900 py-3 rounded mb-1 mt-2 mx-auto px-6">
      <p>
        <?=$_SESSION['_flash']['email_confirmation'] ?>
      </p>
    </div>
  <?php endif; ?>
