...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
  ...
  <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-sm">
    ...
    <div>
        <label for="username" class="block text-sm font-medium leading-6 text-gray-500"><?= $type ? "Hotelname" : "Username" ?></label>
        <div class="mt-2">
    ...
    <p class="mt-8 text-center text-sm text-gray-500">
      <a href="/login?hotel=true" class="font-semibold leading-6 text-red-500 hover:text-red-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600">I Already have an account.</a>
    </p>
  </div>
</div>
